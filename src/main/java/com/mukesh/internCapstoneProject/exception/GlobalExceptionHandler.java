...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> errorResponse(TokenExpiredException exception) {
        ErrorResponse response = ErrorResponse.builder()
    ...
    public ResponseEntity<ErrorResponse> errorResponse(FileCreationException exception) {
        ErrorResponse response = ErrorResponse.builder()
                .status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .message(exception.getMessage())
                .timestamp(LocalDateTime.now())
    ...
    public ResponseEntity<ErrorResponse> errorResponse(DataAccessException exception) {
        ErrorResponse response = ErrorResponse.builder()
                .status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .message(exception.getMessage())
                .timestamp(LocalDateTime.now())
    ...
    public ResponseEntity<ErrorResponse> errorResponse(NotificationServiceException exception) {
        ErrorResponse response = ErrorResponse.builder()
                .status(HttpStatus.INTERNAL_SERVER_ERROR.value())
                .message(exception.getMessage())
                .timestamp(LocalDateTime.now())
    ...
    ResponseEntity<Map<String, String>> validationExceptionHandler(MethodArgumentNotValidException ex){
